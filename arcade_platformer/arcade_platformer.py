...
class Enemy(arcade.AnimatedWalkingSprite):
    ...
    def __init__(self, pos_x: int, pos_y: int) -> None:
        ...
        walking_texture_path = [
            texture_path / "covid.png",
            texture_path / "covid.png",
        ]
        standing_texture_path = texture_path / "covid.png"
...
class PlatformerView(arcade.View):
    ...
    def create_player_sprite(self) -> arcade.AnimatedWalkingSprite:
        ...
        walking_paths = [
            texture_path / f"Run__00{x}.png" for x in (0, 2)
        ]
        climbing_paths = [
            texture_path / f"Climb_00{x}.png" for x in (0, 0)
        ]
        standing_paths = [
            texture_path / f"Idle__00{x}.png" for x in (0, 0)
            ]
        ...
        standing_right_textures = [
            arcade.load_texture(texture) for texture in standing_paths
        ]

        standing_left_textures = [
            arcade.load_texture(texture, mirrored=True)
            for texture in standing_paths
        ]
